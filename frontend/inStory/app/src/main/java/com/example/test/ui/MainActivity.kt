...
import com.example.test.`networking-example`.AuthService
import com.example.test.`networking-example`.auth.AuthManager
import com.example.test.ui.extensions.addFragment
import com.example.test.ui.extensions.replaceFragment
